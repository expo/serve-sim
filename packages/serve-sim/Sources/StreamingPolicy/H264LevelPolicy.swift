...
public enum H264LevelPolicy {
    ...
    static let absentParameterLevelIdc = defaultLevelIdc
    ...
    /// 3600 is Level 3.1's, repeated rather than forced out of the table so an edit to either
    /// cannot crash the publisher.
