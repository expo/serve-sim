...
//
// `@ngrok/ngrok` must also stay external because its optional package chooses
// a native sidecar at install time. Bundling it into dist/serve-sim.js breaks
// `npx` installs by separating the JS wrapper from its platform .node file.
const nodeExternals = [
  "fs",
  "path",
  "os",
