...
export const SIMULATOR_RESIZE_SCALE_STORAGE_KEY = "serve-sim:simulator-frame-scale";
...
export function getPresentationFrameWidth(
  viewportWidth: number,
  viewportHeight: number,
  aspectRatio: number,
...
export function snapContainBox(
  ...
  return {
    width,
    height,
    fillsViewport: width === viewportWidth && height === viewportHeight,
  };
}
